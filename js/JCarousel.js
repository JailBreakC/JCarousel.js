var JCarousel = function(box, container, showNum, moveNum) {
    ...
    var getAttr = function (){
        ...
        if (box[0] === '.') {
            ...
            throw "The arigument should be a .classname or #id";
        }
        if (container[0] === '.') {
    ...
    var handler = attr.container,
        ...
        nowIndex = 0;
        prev = creatEle('div',{'id':'prevHandler'}),
        next = creatEle('div',{'id':'nextHandler'});
